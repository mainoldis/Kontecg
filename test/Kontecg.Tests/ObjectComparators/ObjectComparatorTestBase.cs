using System;
using System.Linq;
using Kontecg.ObjectComparators;
using Kontecg.ObjectComparators.BooleanComparators;
using Kontecg.ObjectComparators.DateTimeComparators;
using Kontecg.ObjectComparators.IntComparators;
using Kontecg.ObjectComparators.LongComparators;
using Kontecg.ObjectComparators.StringComparators;
using Shouldly;
using Xunit;

namespace Kontecg.Tests.ObjectComparators
{
