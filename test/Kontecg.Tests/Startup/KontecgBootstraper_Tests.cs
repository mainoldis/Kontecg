...
namespace Kontecg.Tests.Startup
{
    public class KontecgBootstraper_Tests : TestBaseWithLocalIocManager
    {
        private readonly KontecgBootstrapper _bootstrapper;

        public KontecgBootstraper_Tests()
        {
            _bootstrapper = KontecgBootstrapper.Create<MyTestModule>(options =>
            {
    ...
    public abstract class MyEventCounterModuleBase : KontecgModule
    {
