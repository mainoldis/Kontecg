...
namespace Kontecg.EntityFrameworkCore.Tests.Ef
{
    ...
    public class SupportDbContext : KontecgDbContext
    {
        public DbSet<Ticket> Tickets { get; set; }

        public DbSet<TicketListItem> TicketListItems { get; set; }

        public const string TicketViewSql = @"CREATE VIEW TicketListItemView AS SELECT Id, EmailAddress, CompanyId, IsActive FROM Tickets";
