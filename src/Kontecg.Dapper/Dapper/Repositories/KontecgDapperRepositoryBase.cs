...
namespace Kontecg.Dapper.Repositories
{
    ...
    public abstract class KontecgDapperRepositoryBase<TEntity, TPrimaryKey> : IDapperRepository<TEntity, TPrimaryKey>
        where TEntity : class, IEntity<TPrimaryKey>
    {
        static KontecgDapperRepositoryBase()
        {
            MultiCompanySideAttribute attr =
                typeof(TEntity).GetSingleAttributeOfTypeOrBaseTypesOrNull<MultiCompanySideAttribute>();
            if (attr != null)
            {
                MultiCompanySide = attr.Side;
            }
        }

        public static MultiCompanySides? MultiCompanySide { get; }
        ...
        protected static Expression<Func<TEntity, bool>> CreateEqualityExpressionForId(TPrimaryKey id)
        {
            ...
            object value = Convert.ChangeType(id, typeof(TPrimaryKey));
            ConstantExpression valueExpression = Expression.Constant(value, typeof(TPrimaryKey));
