...
using Kontecg.Dapper.Extensions;
using Kontecg.Dapper.Filters.Action;
using Kontecg.Dapper.Filters.Query;
using Kontecg.Data;
...
{
    public class DapperRepositoryBase<TEntity, TPrimaryKey> : KontecgDapperRepositoryBase<TEntity, TPrimaryKey>
        where TEntity : class, IEntity<TPrimaryKey>
    {
        ...
        public virtual DbConnection GetConnection()
        {
            IDbConnection connection =
                _activeTransactionProvider.GetActiveConnection(ActiveTransactionProviderArgs.Empty);
        ...
        {
            IDbTransaction connection =
                _activeTransactionProvider.GetActiveTransaction(ActiveTransactionProviderArgs.Empty);
            return (DbTransaction) connection;
        }
        ...
        public override async Task<IEnumerable<TEntity>> QueryAsync(string query, object parameters = null)
        {
            ...
            DbTransaction activeTransaction = await GetActiveTransactionAsync();
