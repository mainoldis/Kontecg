...
{
    /// <summary>
    ///     A robust timer implementation that ensures no overlapping occurs. It waits exactly specified <see cref="Period" />
    ///     between ticks.
    /// </summary>
    //TODO: Extract interface or make all members virtual to make testing easier.
    public class KontecgTimer : RunnableBase, ITransientDependency
    {
        /// <summary>
        ...
        public KontecgTimer(int period, bool runOnStart = false)
            : this()
        {
            Period = period;
