...
namespace Kontecg.Authorization
{
    ...
    ///     This class can be used in database migrations or in unit tests where Kontecg is not initialized.
    /// </summary>
    public static class PermissionFinder
    {
        /// <summary>
        ///     Collects and gets all permissions in given providers.
        ///     This method can be used to get permissions in database migrations or in unit tests where Kontecg is not
        ///     initialized.
        ...
        internal class InternalPermissionFinder : PermissionDefinitionContextBase
        {
            ...
            {
                foreach (AuthorizationProvider provider in authorizationProviders)
                {
