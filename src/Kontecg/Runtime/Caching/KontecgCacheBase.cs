...
{
    /// <summary>
    ///     Base class for caches with generic types, <see cref="KontecgCacheBase{TKey, TValue}" /> and .
    ///     It provides default implementation of <see cref="IKontecgCache{TKey, TValue}" />.
    /// </summary>
    public abstract class KontecgCacheBase<TKey, TValue> : KontecgCacheBase, IKontecgCache<TKey, TValue>, ICacheOptions
    {
        ...
        protected KontecgCacheBase(string name) : base(name)
        {
    ...
    /// </summary>
    public abstract class KontecgCacheBase : IDisposable, IKontecgCache
    {
        /// <summary>
        ///     Constructor.
        /// </summary>
        /// <param name="name"></param>
        protected KontecgCacheBase(string name)
        {
            Name = name;
