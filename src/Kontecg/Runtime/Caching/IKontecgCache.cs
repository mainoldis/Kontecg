...
{
    public interface IKontecgCache<TKey, TValue> : IKontecgCache
    {
        /// <summary>
        ...
        /// <see cref="ICacheOptions.DefaultAbsoluteExpireTimeFactory"/> or <see cref="ICacheOptions.DefaultAbsoluteExpireTime"/> will be used if it's not null. Otherwise, <see cref="ICacheOptions.DefaultSlidingExpireTime"/>
        /// will be used.
        /// </summary>
        /// <param name="key">Key</param>
    ...
    /// </summary>
    public interface IKontecgCache
    {
        /// <summary>
