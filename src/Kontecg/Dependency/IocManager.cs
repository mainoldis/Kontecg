...
namespace Kontecg.Dependency
{
    ...
    public class IocManager : IIocManager
    {
        ...
        ///     From Castle.Core documentation it is highly recommended to use single instance of ProxyGenerator to avoid
        ///     memoryleaks and performance issues
        ...
        {
            ConventionalRegistrationContext context = new ConventionalRegistrationContext(assembly, this, config);

            foreach (IConventionalDependencyRegistrar registerer in _conventionalRegistrars)
            {
            ...
            where T : class
        {
            ...
            {
                DependencyLifeStyle.Transient => registration.LifestyleTransient(),
                DependencyLifeStyle.Singleton => registration.LifestyleSingleton(),
                _ => registration
            };
        }
    }
