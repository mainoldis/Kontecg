...
namespace Kontecg
{
    ...
    /// </summary>
    [Obsolete("Use UuidGenerator instead of SequentialGuidGenerator due a poor Guid generation. UuidGenerator implements UUID (GUID v7)")]
    public class SequentialGuidGenerator : IGuidGenerator
    {
        ...
        public Guid Create(SequentialGuidDatabaseType databaseType)
        {
            switch (databaseType)
            {
                ...
                case SequentialGuidDatabaseType.PostgresSql:
                    return Create(SequentialGuidType.SequentialAsString);
                default:
