...
namespace Kontecg.Domain.Entities
{
    ...
    public static class EntityHelper
    {
        ...
        public static Type GetPrimaryKeyType(Type entityType)
        {
            ...
            throw new KontecgException("Can not find primary key type of given entity type: " + entityType + ". Be sure that this entity type implements IEntity<TPrimaryKey> interface");
        }
        ...
        public static object GetEntityId(object entity)
        {
            ...
            {
                throw new KontecgException(entity.GetType() + " is not an Entity !");
            }

            return ReflectionHelper.GetValueByPath(entity, entity.GetType(), "Id");
        }

        public static string GetHardDeleteKey(object entity, int? companyId)
        {
            if (MultiCompanyHelper.IsMultiCompanyEntity(entity))
            {
                var companyIdString = companyId.HasValue ? companyId.ToString() : "null";
                return entity.GetType().FullName + ";CompanyId=" + companyIdString + ";Id=" + GetEntityId(entity);
            }
