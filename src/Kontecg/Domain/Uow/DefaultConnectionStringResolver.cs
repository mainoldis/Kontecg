...
namespace Kontecg.Domain.Uow
{
    ...
    /// Get connection string from <see cref="IKontecgStartupConfiguration"/>,
    ...
    public class DefaultConnectionStringResolver : IConnectionStringResolver, ITransientDependency
    {
        ...
        /// </summary>
        public DefaultConnectionStringResolver(IKontecgStartupConfiguration configuration)
        {
        ...
        public virtual string GetNameOrConnectionString(ConnectionStringResolveArgs args)
        {
            ...
            throw new KontecgException("Could not find a connection string definition for the application. Set IKontecgStartupConfiguration.DefaultNameOrConnectionString or add a 'Default' connection string to application .config file.");
        }
