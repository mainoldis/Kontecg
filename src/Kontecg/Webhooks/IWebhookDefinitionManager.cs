...
namespace Kontecg.Webhooks
{
    public interface IWebhookDefinitionManager
    {
        ...
        /// <summary>
        ///     Checks if given webhook name is available for given company.
        /// </summary>
        Task<bool> IsAvailableAsync(int? companyId, string name);

        /// <summary>
        ///     Checks if given webhook name is available for given company.
        /// </summary>
        bool IsAvailable(int? companyId, string name);
    }
}
