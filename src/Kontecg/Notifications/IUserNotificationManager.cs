...
namespace Kontecg.Notifications
{
    ...
    public interface IUserNotificationManager
    {
        ...
        Task<UserNotification> GetUserNotificationAsync(int? companyId, Guid userNotificationId);
        ...
        /// <param name="companyId">Company Id</param>
        /// <param name="userNotificationId">The user notification id.</param>
        UserNotification GetUserNotification(int? companyId, Guid userNotificationId);
