...
namespace Kontecg.Notifications
{
    ...
    ///     This notification is distributed to companies and users by <see cref="INotificationDistributer" />.
    /// </summary>
    [Serializable]
    [Table("notifications", Schema = "log")]
    [MultiCompanySide(MultiCompanySides.Host)]
    public class NotificationInfo : CreationAuditedEntity<Guid>
    {
        /// <summary>
        ///     Indicates all company ids for <see cref="CompanyIds" /> property.
        ///     Value: "0".
        /// </summary>
        public const string AllCompanyIds = "0";
        ...
        /// <summary>
        ///     Maximum length of <see cref="CompanyIds" /> property.
        ///     Value: 131072 (128 KB).
        /// </summary>
        public const int MaxCompanyIdsLength = 128 * 1024;
        ...
        /// <summary>
        ///     Target companies of the notification.
        ///     Used to send notification to subscribed users of specific company(-ies).
        ///     This is valid only if UserIds is null.
        ///     If it's "0", then indicates to all companys.
        /// </summary>
        [StringLength(MaxCompanyIdsLength)]
