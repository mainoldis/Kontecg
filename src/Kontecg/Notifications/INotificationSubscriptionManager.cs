...
namespace Kontecg.Notifications
{
    ...
    public interface INotificationSubscriptionManager
    {
        ...
        /// <summary>
        ///     Gets all subscribtions for given notification (including all companies).
        ///     This only works for single database approach in a multicompany application!
        /// </summary>
        /// <param name="notificationName">Name of the notification.</param>
        /// <param name="entityIdentifier">entity identifier</param>
        ...
        /// <param name="notificationName">Name of the notification.</param>
        /// <param name="entityIdentifier">entity identifier</param>
        List<NotificationSubscription> GetSubscriptions(string notificationName,
            EntityIdentifier entityIdentifier = null);

        /// <summary>
        ///     Gets all subscribtions for given notification.
        /// </summary>
        /// <param name="companyId">Company id. Null for the host.</param>
        /// <param name="notificationName">Name of the notification.</param>
        /// <param name="entityIdentifier">entity identifier</param>
        Task<List<NotificationSubscription>> GetSubscriptionsAsync(int? companyId, string notificationName,
            EntityIdentifier entityIdentifier = null);
        ...
        /// <param name="notificationName">Name of the notification.</param>
        /// <param name="entityIdentifier">entity identifier</param>
        List<NotificationSubscription> GetSubscriptions(int? companyId, string notificationName,
            EntityIdentifier entityIdentifier = null);
        ...
        /// <param name="notificationName">Name of the notification.</param>
        /// <param name="entityIdentifier">entity identifier</param>
        Task<bool> IsSubscribedAsync(UserIdentifier user, string notificationName,
            EntityIdentifier entityIdentifier = null);
