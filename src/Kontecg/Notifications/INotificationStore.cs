...
namespace Kontecg.Notifications
{
    ...
    public interface INotificationStore
    {
        ...
        ///     Gets subscriptions for a notification.
        /// </summary>
        List<NotificationSubscriptionInfo> GetSubscriptions(string notificationName, string entityTypeName,
            string entityId);

        /// <summary>
        ///     Gets subscriptions for a notification for specified company(s).
        /// </summary>
        Task<List<NotificationSubscriptionInfo>> GetSubscriptionsAsync(int?[] companyIds, string notificationName,
            string entityTypeName, string entityId);

        /// <summary>
        ///     Gets subscriptions for a notification for specified company(s).
        /// </summary>
        List<NotificationSubscriptionInfo> GetSubscriptions(int?[] companyIds, string notificationName,
            string entityTypeName, string entityId);
        ...
        /// </summary>
        Task UpdateUserNotificationStateAsync(int? companyId, Guid userNotificationId, UserNotificationState state);

        /// <summary>
        ///     Updates a user notification state.
        /// </summary>
        void UpdateUserNotificationState(int? companyId, Guid userNotificationId, UserNotificationState state);
        ...
        /// </summary>
        Task DeleteUserNotificationAsync(int? companyId, Guid userNotificationId);

        /// <summary>
        ///     Deletes a user notification.
        /// </summary>
        void DeleteUserNotification(int? companyId, Guid userNotificationId);
        ...
        /// <param name="startDate">List notifications published after startDateTime</param>
        /// <param name="endDate">List notifications published before startDateTime</param>
        List<UserNotificationInfoWithNotificationInfo> GetUserNotificationsWithNotifications(UserIdentifier user,
        ...
        Task<UserNotificationInfoWithNotificationInfo> GetUserNotificationWithNotificationOrNullAsync(int? companyId,
        ...
        /// <param name="companyId">Company Id</param>
        /// <param name="userNotificationId">Skip count.</param>
        UserNotificationInfoWithNotificationInfo GetUserNotificationWithNotificationOrNull(int? companyId,
            Guid userNotificationId);

        /// <summary>
        ///     Inserts notification for a company.
        /// </summary>
        Task InsertCompanyNotificationAsync(CompanyNotificationInfo companyNotificationInfo);

        /// <summary>
        ///     Inserts notification for a company.
        /// </summary>
        void InsertCompanyNotification(CompanyNotificationInfo companyNotificationInfo);
