...
namespace Kontecg.BackgroundJobs
{
    ...
    /// </summary>
    [Table("background_jobs", Schema = "job")]
    ...
    public class BackgroundJobInfo : CreationAuditedEntity<long>
    {
        ...
        ///     Value: 512.
        /// </summary>
        public const int JobTypeLength = 512;

        /// <summary>
        ///     Maximum length of <see cref="JobArgs" />.
        ///     Value: 1 MB (1,048,576 bytes).
        /// </summary>
        public const int JobArgsLength = 1024 * 1024;
        ...
        public virtual DateTime? CalculateNextTryTime()
        {
            ...
            DateTime nextTryDate = LastTryTime?.AddSeconds(nextWaitDuration) ?? Clock.Now.AddSeconds(nextWaitDuration);
            return nextTryDate.Subtract(CreationTime).TotalSeconds > DefaultTimeout ? null : nextTryDate;
        }
    }
}
