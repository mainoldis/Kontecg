...
namespace Kontecg.DynamicEntityProperties
{
    public class DynamicEntityPropertyDefinitionManager : IDynamicEntityPropertyDefinitionManager, ISingletonDependency
    {
        ...
        {
            string inputTypeName = InputTypeBase.GetName<TInputType>();
        ...
        public void Initialize()
        {
            IDynamicEntityPropertyDefinitionContext context =
                _iocManager.Resolve<IDynamicEntityPropertyDefinitionContext>();
            context.Manager = this;

            foreach (Type providerType in _dynamicEntityPropertiesConfiguration.Providers)
            {
                using IDisposableDependencyObjectWrapper<DynamicEntityPropertyDefinitionProvider> provider =
