...
{
    [Table("entity_property_changes", Schema = "log")]
    public class EntityPropertyChange : Entity<long>, IMayHaveCompany
    {
        /// <summary>
        ...
        /// <summary>
        ///     Use to set original value. (Also fills <see cref="OriginalValueHash" /> according to
        ...
        /// <summary>
        ///     Returns if NewValue and OriginalValue are equal. Uses hash to compare, if <see cref="NewValueHash" /> and
        ///     <see cref="OriginalValueHash" /> are not null or empty.
        /// </summary>
