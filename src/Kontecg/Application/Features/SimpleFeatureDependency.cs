...
namespace Kontecg.Application.Features
{
    ...
    public class SimpleFeatureDependency : IFeatureDependency
    {
        ...
        {
            return context.CompanyId.HasValue
                ? context.FeatureChecker.IsEnabledAsync(context.CompanyId.Value, RequiresAll, Features)
        ...
        {
            return context.CompanyId.HasValue
                ? context.FeatureChecker.IsEnabled(context.CompanyId.Value, RequiresAll, Features)
