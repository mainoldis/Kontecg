...
{
    /// <summary>
    ///     Defines a feature of the application. A <see cref="Feature" /> can be used in a multi-company application
    ///     to enable or disable some application features depending on editions and companies.
    /// </summary>
    public class Feature
    {
        ...
        ///     This value is used if this feature's value is not defined for the current company.
        /// </summary>
        ...
        public Feature CreateChildFeature(string name, string defaultValue, ILocalizableString displayName = null,
            ILocalizableString description = null, FeatureScopes scope = FeatureScopes.All, IInputType inputType = null)
        {
            Feature feature = new Feature(name, defaultValue, displayName, description, scope, inputType)
                {Parent = this};
        ...
        {
            Feature featureToRemove = _children.FirstOrDefault(f => f.Name == name);
