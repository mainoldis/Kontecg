...
namespace Kontecg.Application.Navigation
{
    ...
    public static class MenuItemDefinitionExtensions
    {
        ...
        {
            MenuItemDefinition menuItem = GetMenuItem(menuItems, menuItemName);
        ...
        {
            MenuItemDefinition menuItem = GetMenuItem(menuItems, menuItemName);
            MenuItemDefinition targetMenuItem = GetMenuItem(menuItems, targetMenuItemName);
            menuItems.Remove(menuItem);
        ...
        {
            MenuItemDefinition menuItem = menuItems.FirstOrDefault(i => i.Name == menuItemName);
            if (menuItem == null)
            {
                throw new KontecgException("Can not find menu item: " + menuItemName);
            }
