...
{
    /// <summary>
    ///     Used to configure Kontecg and modules on startup.
    /// </summary>
    public interface IKontecgStartupConfiguration : IDictionaryBasedConfig
    {
        /// <summary>
        ...
        /// </summary>
        IMultiCompanyConfig MultiCompany { get; }
        ...
        /// </summary>
        IUpdateConfiguration Updates { get; }
        ...
        /// <summary>
        ///     Used to configure workflow system.
        /// </summary>
        IWorkflowsConfiguration Workflows { get; }
