namespace Kontecg.Data
{
    ...
    public struct ConditionalValue<TValue>
    {
        ...
        /// <summary>
        ///     Gets a value indicating whether the current <cref name="ConditionalValue{TValue}" /> object has a valid value of
        ///     its underlying type.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the value of the current <cref name="ConditionalValue{TValue}" /> object if it has been assigned a valid
        ///     underlying value.
        /// </summary>
        /// <returns>
        ///     The value of the object. If HasValue is <languageKeyword>false</languageKeyword>, returns the default value
        ///     for type of the TValue parameter.
        /// </returns>
