...
namespace Kontecg.EFCore.Repositories
{
    ...
    public class EfCoreRepositoryBase<TDbContext, TEntity, TPrimaryKey> :
        KontecgRepositoryBase<TEntity, TPrimaryKey>,
        ...
        where TDbContext : DbContext
    {
        ...
        {
            return await _dbContextProvider.GetDbContextAsync(MultiCompanySide);
        }
        ...
        {
            return _dbContextProvider.GetDbContext(MultiCompanySide);
        }
