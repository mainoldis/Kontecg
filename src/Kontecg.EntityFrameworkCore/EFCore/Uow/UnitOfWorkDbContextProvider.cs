...
namespace Kontecg.EFCore.Uow
{
        ...
        where TDbContext : DbContext
    {
        ...
        {
            return _currentUnitOfWorkProvider.Current.GetDbContextAsync<TDbContext>(multiCompanySide);
        }
        ...
        {
            return _currentUnitOfWorkProvider.Current.GetDbContext<TDbContext>(multiCompanySide);
        }
    }
}
