...
namespace Kontecg.Authorization.Users
{
    ...
    /// </summary>
    [Table("user_tokens", Schema = "seg")]
    public class UserToken : Entity<long>, IMayHaveCompany
    {
        /// <summary>
        ...
        protected internal UserToken(KontecgUserBase user, [NotNull] string loginProvider, [NotNull] string name, string value, DateTime? expireDate = null)
        {
