...
namespace Kontecg.Authorization.Users
{
    ...
    /// </summary>
    public class KontecgUserStore<TRole, TUser> :
        ...
        where TUser : KontecgUser<TUser>
    {
        ...
        /// <summary>
        /// Gets the normalized username for the specified <paramref name="user"/>.
        /// </summary>
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                ...
                catch (KontecgDbConcurrencyException ex)
                {
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                ...
                user.Roles.Add(new UserRole(user.CompanyId, user.Id, role.Id));
            });
        }
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                ...
                user.Logins.Add(new UserLogin(user.CompanyId, user.Id, login.LoginProvider, login.ProviderKey));
            });
        }
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                ...
                var query = from userLogin in await _userLoginRepository.GetAllAsync()
                            ...
                            where userLogin.LoginProvider == loginProvider &&
                                      ...
                                      userLogin.CompanyId == KontecgSession.CompanyId
                            select user;
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                ...
                var query = from userclaims in await _userClaimRepository.GetAllAsync()
                            ...
                            where userclaims.ClaimValue == claim.Value && userclaims.ClaimType == claim.Type &&
                                      userclaims.CompanyId == KontecgSession.CompanyId
                            select user;
        ...
        /// <param name="userNameOrEmailAddress">User name or email address</param>
        /// <returns>User or null</returns>
        public virtual async Task<TUser> FindByNameOrEmailAsync(int? companyId, string userNameOrEmailAddress)
        {
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
        ...
        public virtual async Task<TUser> FindAsync(int? companyId, UserLoginInfo login)
        {
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                using (_unitOfWorkManager.Current.SetCompanyId(companyId))
        ...
        private const string InternalLoginProvider = "[KontecgUserStore]";
