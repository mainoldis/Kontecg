    ...
    internal static class SettingExtensions
    {
        ...
        public static Setting ToSetting(this SettingInfo settingInfo)
        {
            return settingInfo == null
                ? null
                : new Setting(settingInfo.CompanyId, settingInfo.UserId, settingInfo.Name, settingInfo.Value);
        }
        ...
        public static SettingInfo ToSettingInfo(this Setting setting)
        {
            return setting == null
                ? null
                : new SettingInfo(setting.CompanyId, setting.UserId, setting.Name, setting.Value);
        }
    }
}
