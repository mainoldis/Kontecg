...
namespace Kontecg.Castle.Logging.MsLogging
{
    ...
    {
        public static void Log(this ICastleLogger logger, LogLevel logLevel, string message)
        {
            switch (logLevel)
            {
        ...
        public static void Log(this ICastleLogger logger, LogLevel logLevel, string message, Exception exception)
        {
            switch (logLevel)
            {
                case LogLevel.Critical:
        ...
        public static void Log(this ICastleLogger logger, LogLevel logLevel, Func<string> messageFactory)
        {
            switch (logLevel)
            {
                case LogLevel.Critical:
