...
namespace Kontecg.Runtime.Caching.Redis
{
    ...
    public class DefaultRedisCacheSerializer : IRedisCacheSerializer, ITransientDependency
    {
        ...
        public virtual object Deserialize(RedisValue objbyte)
        {
            ...
            serializerSettings.Converters.Insert(0, new KontecgDateTimeConverter());

            var cacheData = KontecgCacheData.Deserialize(objbyte);
        ...
        {
            var json = KontecgCacheData.Serialize(value);
