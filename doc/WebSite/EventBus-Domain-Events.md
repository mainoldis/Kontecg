...
Kontecg platform defines **KontecgHandledExceptionData** and triggers
...
(Kontecg platform automatically logs all exceptions). You can
...
Entity change events are defined in the **Kontecg.Events.Bus.Entities**
namespace and are **automatically triggered** by Kontecg platform
...
Kontecg platform finds all the classes that implement **IEventHandler**
...
handlers. Kontecg platform also uses this class in automatic
