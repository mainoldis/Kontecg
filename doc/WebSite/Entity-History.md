...
Kontecg platform provides an infrastructure to automatically log all
entity and property changes.

The saved fields for an entity change are: The related **company id**,
**entity change set id**, **entity id**,
**entity type name**, **change time** and the **change type**.

The saved fields for an entity property change are: The related **company id**,
...
The saved fields for an entity change set are: The related **company id**,
...
[**IKontecgSession**](/Pages/Documents/Kontecg-Session) to
...
The **Kontecg.AspNetCore** package implements **HttpRequestEntityChangeSetReasonProvider**,
