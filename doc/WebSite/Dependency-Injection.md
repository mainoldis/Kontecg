...
Kontecg platform uses the [Castle
...
### Kontecg platform Dependency Injection Infrastructure

Kontecg platform makes using the dependency injection framework almost 
...
Injection system in Kontecg platform. Most of time, conventional
registration will be sufficient.

##### Conventional Registrations

Kontecg platform automatically registers all
...
Kontecg platform automatically registers it since it implements the
...
Kontecg platform can register assemblies by convention. It's pretty
easy:
...
module is being initialized. See Kontecg platform's [module
...
conventional registration rules. Kontecg platform provides the
...
be impossible. Kontecg platform provides some services that can be
...
method (defined in the Kontecg.Dependency namespace) to safely release all
...
automatically by Kontecg platform by extending ASP.NET MVC's default
...
Kontecg platform simplifies and automates dependency injection
