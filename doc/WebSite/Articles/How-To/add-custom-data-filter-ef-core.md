...
When you log in as host user you should see an emtpy page. But if you log in as admin user of Default Company, you will see the document titles as below:
