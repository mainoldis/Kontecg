...
Kontecg platform defines two basic interfaces for Multi-Lingual entity definitions to provide a standard model for translating entities. 
...
For this purpose, kontecg defines CreateMultiLingualMap extension method to map a Multi-Lingual entity and one of it's Translation to an appropriate Dto class using **AutoMapper**. 
...
And it's mapping configuration is;
	...
	Configuration.Modules.KontecgAutoMapper().Configurators.Add(configuration =>
	{
