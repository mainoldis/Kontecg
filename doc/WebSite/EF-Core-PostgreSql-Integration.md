...
```c#
public class PostgreSqlDemoDbContext : KontecgZeroDbContext<Company, Role, User, PostgreSqlDemoDbContext>
{
...
**Note:** By default kontecg's UnitOfWork uses IsolationLevel.ReadUncommitted but it is treated as IsolationLevel.ReadCommitted in PostgreSQL. This behavior can cause problems in some cases. For more information [see](https://github.com/aspnetboilerplate/aspnetboilerplate/issues/3369#issuecomment-433733606).